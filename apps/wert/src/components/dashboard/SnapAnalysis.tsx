  ...
  return (
    <div className="max-w-md mx-auto min-h-full w-full flex flex-col items-center justify-start py-6 px-4 gap-6 font-sans">
      <div className="w-full">
        ...
        <div className="bg-white rounded-2xl shadow-[0_4px_0_-2px_#C8CCD2] border border-slate-100 p-4 mb-4">
          <div className="text-sm text-slate-500 mb-1">净值变化</div>
        ...
        <div className="mb-4">
          <button
            className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-3 hover:text-slate-900"
        ...
        {/* Asset Details */}
        <div className="mb-2">
          <h3 className="text-sm font-bold text-slate-700 mb-3">资产明细</h3>
        </div>
