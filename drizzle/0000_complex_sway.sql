CREATE TYPE "public"."asset_category" AS ENUM('CASH', 'STOCK', 'REAL_ESTATE', 'LIABILITY');
...
--> statement-breakpoint
CREATE TABLE "asset_account" IF NOT EXISTS (
...
--> statement-breakpoint
CREATE TABLE "exchange_rate" IF NOT EXISTS (
...
--> statement-breakpoint
CREATE TABLE "snapshot_item" IF NOT EXISTS (
    "id" uuid PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "snapshot" IF NOT EXISTS (
    "id" uuid PRIMARY KEY NOT NULL,
    "userId" uuid NOT NULL,
